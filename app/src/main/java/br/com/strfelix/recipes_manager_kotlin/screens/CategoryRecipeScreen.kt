...
import br.com.strfelix.recipes_manager_kotlin.repository.getCategoryById
import br.com.strfelix.recipes_manager_kotlin.repository.getRecipesByCategory
...
private fun CategoryRecipeScreenPreview() {
    RecipesmanagerkotlinTheme() {
        CategoryRecipeScreen( 1000, navController = null)
    }
}